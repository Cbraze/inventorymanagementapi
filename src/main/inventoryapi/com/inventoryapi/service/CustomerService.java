...
import com.inventoryapi.repository.CustomerRepository;
...
public class CustomerService {
    ...
    public Customer updateCustomer(Customer customer, Long id) throws Exception {
        try {
            ...
            logger.error("Exception has occurred while trying to update customer: " + id, e);
    ...
    public void deleteCustomer(Long id) throws Exception {
        try {
            ...
            logger.error("Exception has occurred while trying to delete customer: " + id, e);
